...
import static constants.Constants.NUM_PLAYERS;
...
//        
    ...
    public void trumpCheck()
    {
        ...
        {
            Player player = table.get(currentPlayer);
            player.makeTrump();
            
            if(player.isAcceptTrump() == true)
            {
                for(Team team : teams)
                {
                    ...
                    {
                        trumpTeam = team;
                        JOptionPane.showMessageDialog(null, team.getTeamName() + " has called trump");
                        i=3;//end the loop when the current player accepts the trump card
                    }
                }
            }
            else
        ...
        while(trumpCheck < NUM_PLAYERS)
        {
            ...
            if(player.isAcceptTrump() == true)
            {
                for(Team team : teams)
                {
                    ...
                    {
                        trumpTeam = team;
                        JOptionPane.showMessageDialog(null, team.getTeamName() + " accepted the Trump Suit");
                        break;
                    }
                }
            }
